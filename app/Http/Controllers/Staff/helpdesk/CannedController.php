 ...
 * CannedController.
 *
 * This controller is for all the functionalities of Canned response for Staff in the Staff Panel
 *
...
class CannedController extends Controller
{
    ...
    {
        try {
            return view('themes.default1.staff.helpdesk.canned.index');
        } catch (Exception $ex) {
    ...
    {
        try {
            return view('themes.default1.staff.helpdesk.canned.create');
        } catch (Exception $ex) {
            return redirect()->back()->with('fails', $ex->getMessage());
        }
    }
    ...
    public function edit($id, Canned $canned)
    {
        try {
            ...
            return view('themes.default1.staff.helpdesk.canned.edit', compact('canned'));
        } catch (Exception $ex) {
            return redirect()->back()->with('fails', $ex->getMessage());
        }
    }
