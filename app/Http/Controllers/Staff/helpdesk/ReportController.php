...
/**
 * ReportController
 * This controlleris used to fetch reports in the staff panel.
 *
...
class ReportController extends Controller
{
    ...
    {
        try {
            return view('themes.default1.staff.helpdesk.report.index');
        } catch (Exception $e) {
        }
    }
    ...
    public function chartdataHelptopic(Request $request, $date111 = '', $date122 = '', $helptopic = '')
    {
        ...
        if ($date11 && $date12 && $help_topic) {
            ...
            //            $help_topic = HelpTopic::where('status', '=', '1')->min('id');
        }
        $return = '';
        $last = '';
        $j = 0;
    ...
    public function helptopicPdf(Request $request)
    {
        ...
        $html = view('themes.default1.staff.helpdesk.report.pdf', compact('table_datas', 'table_help_topic'))->render();
