...
class ArticleController extends Controller
{
    ...
    public function test()
    {
        ...
        return view('themes.default1.staff.kb.article.test');
    }
    ...
    public function index()
    {
        ...
        try {
            ...
            return view('themes.default1.staff.kb.article.index');
        } catch (Exception $e) {
    ...
    public function create(Category $category)
    {
        ...
        try {
            ...
            return view('themes.default1.staff.kb.article.create', compact('category'));
        } catch (Exception $e) {
            return redirect()->back()->with('fails', $e->getMessage());
        }
    }
    ...
    public function edit($slug)
    {
        ...
        try {
            return view('themes.default1.staff.kb.article.edit', compact('assign', 'article', 'category'));
        } catch (Exception $e) {
            return redirect()->back()->with('fails', $e->getMessage());
        }
    }
