...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        /*  get the view of index of the catogorys with all attributes
          of category model */
        try {
            return view('themes.default1.staff.kb.category.index');
        } catch (Exception $e) {
    ...
    public function create(Category $category)
    {
        ...
        /* get the view page to create new category with all attributes
          of category model */
        try {
            return view('themes.default1.staff.kb.category.create', compact('category'));
        } catch (Exception $e) {
            return redirect()->back()->with('fails', $e->getMessage());
        }
    }
    ...
    public function edit($id)
    {
        ...
        return view('themes.default1.staff.kb.category.edit', compact('category', 'categories'));
    }
