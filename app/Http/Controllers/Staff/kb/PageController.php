...
class PageController extends Controller
{
    ...
    public function index()
    {
        ...
        $pages->setPath('page');
        try {
            return view('themes.default1.staff.kb.pages.index', compact('pages'));
        } catch (Exception $e) {
    ...
    {
        return view('themes.default1.staff.kb.pages.create');
    }
    ...
    public function edit($slug)
    {
        try {
            ...
            return view('themes.default1.staff.kb.pages.edit', compact('page'));
        } catch (Exception $e) {
            return redirect('page')->with('fails', $e->getMessage());
        }
    }
