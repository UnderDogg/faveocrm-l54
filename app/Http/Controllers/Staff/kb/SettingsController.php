<?php
namespace App\Http\Controllers\Staff\kb;
...
class SettingsController extends Controller
{
    ...
    public function settings(Settings $settings, Timezones $time, Date_format $date)
    {
        ...
        $time = $time->get();
        //$date = $date->get();
        return view('themes.default1.staff.kb.settings.settings', compact('date', 'settings', 'time'));
    }
    ...
    {
        return view('themes.default1.staff.kb.settings.comment');
    }
    ...
    public function getData()
    {
        return \Datatable::collection(Comment::All())
            ...
            ->addColumn('details', function ($model) {
                ...
                $mailbox = "<p>$model->email</p><br>";
                $website = "<p>$model->website</p><br>";
                return $name . $mailbox . $website;
            })
    ...
    public function getProfile()
    {
        $time = Timezone::all();
        $user = Auth::user();
        return view('themes.default1.staff.kb.settings.profile', compact('user', 'time'));
    }
