...
class TemplateSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        TemplateType::create(['id' => '5', 'name' => 'create-ticket-staff']);
        TemplateType::create(['id' => '6', 'name' => 'create-ticket-by-staff']);
        ...
        TemplateType::create(['id' => '10', 'name' => 'ticket-reply-staff']);
        ...
        Template::truncate();
        Template::create(['id' => '1', 'variable' => '0', 'name' => 'This template is for sending notice to staff when ticket is assigned to them', 'type' => '1',
        ...
        Template::create(['id' => '5', 'variable' => '0', 'name' => 'This template is for sending notice to staff on new ticket creation', 'type' => '5', 'message' => '<div>Hello {!!$ticket_agent_name!!},<br/><br/>New ticket {!!$ticket_number!!}created <br/><br/><b>From</b><br/><b>Name:</b> {!!$ticket_client_name!!}   <br/><b>E-mail:</b> {!!$ticket_client_email!!}<br/><br/> {!!$content!!}<br/><br/>Kind Regards,<br/> {!!$system_from!!}</div>', 'set_id' => '1']);
        Template::create(['id' => '6', 'variable' => '0', 'name' => 'This template is for sending notice to client on new ticket created by staff in name of client', 'type' => '6', 'message' => '<div> {!!$content!!}<br><br> {!!$agent_sign!!}<br><br>You can check the status of or update this ticket online at: {!!$system_link!!}</div>', 'set_id' => '1']);
        Template::create(['id' => '7', 'variable' => '1', 'name' => 'This template is for sending notice to client on new registration during new ticket creation for un registered clients', 'type' => '7', 'subject' => 'Registration Confirmation', 'message' => '<p>Hello {!!$user!!}, </p><p>This email is confirmation that you are now registered at our helpdesk.</p><p><b>Registered Mailboxes:</b> {!!$email_address!!}</p><p><b>Password:</b> {!!$user_password!!}</p><p>You can visit the helpdesk to browse articles and contact us at any time: {!!$system_link!!}</p><p>Thank You.</p><p>Kind Regards,</p><p> {!!$system_from!!} </p>', 'set_id' => '1']);
        ...
        Template::create(['id' => '10', 'variable' => '0', 'name' => 'This template is for sending notice to staff when ticket reply is made by client on a ticket', 'type' => '10', 'message' => '<div>Hello {!!$ticket_agent_name!!},<br/><b><br/></b>A reply been made to ticket {!!$ticket_number!!}<br/><b><br/></b><b>From<br/></b><b>Name: </b>{!!$ticket_client_name!!}<br/><b>E-mail: </b>{!!$ticket_client_email!!}<br/><b><br/></b> {!!$content!!}<br/><b><br/></b>Kind Regards,<br/> {!!$system_from!!}</div>', 'set_id' => '1']);
        Template::create([
            'id' => '11',
            'variable' => '1',
            ...
            'message' => '<p>Hello {!!$user!!}, '
                ...
                . '<p><b>Registered Mailboxes:</b> {!!$email_address!!}</p>'
        ...
        Template::create([
            'id' => '12',
            'variable' => '1',
            'name' => 'This template is for sending escalate notice to staff',
            'type' => '12',
            'subject' => 'SLA Violate',
