                  ...
                  @foreach($notifications->orderBy('created_at', 'desc')->paginate(10) as $notification)
                        ...
                        <li class="task">
                          ...
                          <label for='cl' data-toggle="tooltip" data-placement="top" title="Mark Read"><span></span>&nbsp<img
                            ...
                            <h6 class="textcontent marginzero"><a
                                ...
                                id="{{$notification -> notification_id}}"
                                class='noti_User'>{!! $notification->notification->type->message !!}</a></h6>
                          ...
                          <div class="tools">
                            <a href="{!! route('user.show', $notification -> notification_id) !!}" data-toggle="tooltip"
                               data-placement="top" title="View" id="{{$notification -> notification_id}}"
                               class='noti_User'><i class="fa fa-eye"></i></a>
                            <a href="#" id='{{ $notification -> notification_id }}' data-toggle="tooltip"
                               data-placement="top" title="Delete" class='notification-delete clickfun'><i
                        ...
                        <li>
                          ...
                          <label for='cl' data-toggle="tooltip" data-placement="top" title="Mark Read"><span></span>&nbsp<img
                            ...
                            <h6 class="textcontent marginzero"><a
                                ...
                                class='noti_User'>{!! $notification->notification->type->message !!}</a></h6>
                            <small class="label label-danger"><i
                                class="fa fa-clock-o"></i> {{ $notification123-> created_at }}</small>
                          </label> <!-- Emphasis label -->
                    ...
                    @else
                      @if($notification && $notification->notification && $notification->notification->type && $notification->is_read == 1)
                        <li class="task">
                          <input type="checkbox" value="" name="cc" data-toggle="tooltip" data-placement="top"
                          ...
                          <label for='cl'><span></span>&nbsp<img src="{{$notification->users-> profile_pic}}"
                            ...
                            <h6 class="textcontent marginzero"><a
                                ...
                                id='{{ $notification -> notification_id }}'
                                class='noti_User'>{!! $notification->notification->type->message !!} with id
                                "{!!$notification->notification->model->ticket_number!!}"</a></h6>
                            <small class="label label-info"><i
                                class="fa fa-clock-o"></i> {{ $notification -> created_at }}</small>
                          </label>
                          <div class="tools">
                            <a href="{!! route('ticket.thread', $notification->notification->model_id) !!}"
                               id='{{ $notification -> notification_id }}' data-toggle="tooltip" data-placement="top"
                               title="View" class='noti_User'><i class="fa fa-eye"></i></a>
                            <a href="#" id='{{ $notification -> notification_id }}' data-toggle="tooltip"
                               data-placement="top" title="Delete" class='notification-delete clickfun'><i
                                class="fa fa-trash-o"></i></a>
                          </div>
