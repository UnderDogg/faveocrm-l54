                        ...
                        <li class="task">
                          ...
                          <label for='cl' data-toggle="tooltip" data-placement="top" title="Mark Read"><span></span>&nbsp<img
                            ...
                            <h6 class="textcontent marginzero"><a
                                ...
                                id="{{$notification123 -> notification_id}}"
                                class='noti_User'>{!! $notification123->message !!}</a></h6>
                          ...
                          <div class="tools">
                            <a href="{!! route('user.show', $notification123->notification_id) !!}"
                               ...
                               id="{{$notification123-> notification_id}}" class='noti_User'><i
                                class="fa fa-eye"></i></a>
                            <a href="#" id='{{ $notification123->notification_id }}' data-toggle="tooltip"
                        ...
                        <li class="task">
                          ...
                          <label for='cl'><span></span>&nbsp<img src="{{$user->profile_pic}}" class="img-circle"
                            ...
                            <h6 class="textcontent marginzero"><a
                                ...
                                id='{{ $notification123->notification_id }}'
                                class='noti_User'>{!! $notification123->message !!} with id
                                "{!!$ticket_number->ticket_number!!}"</a></h6>
                            <small class="label label-info"><i
                                class="fa fa-clock-o"></i> {{ $notification123-> created_at }}</small>
                          </label>
                          <div class="tools">
                            <a href="{!! route('ticket.thread', $notification123->model_id) !!}"
                               id='{{ $notification123->notification_id }}' data-toggle="tooltip" data-placement="top"
