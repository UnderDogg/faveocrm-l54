    ...
    <div class="box-body">
      ...
      @if(Session::has('success'))
        ...
        <table class="table table-bordered dataTable" style="overflow:hidden;">
          ...
          @foreach($bans as $ban)
            <tr>
              <!-- Mailboxes Address with Link to Edit page along Id -->
              ...
              <td>
                ...
                </a> <a href="{{route('banlist.delete',$ban->id)}}" class="btn btn-danger btn-xs btn-flat"><i
                    class="fa fa-trash" style="color:black;"> </i> {!! Lang::get('lang.delete') !!}</a>
              </td>
              @endforeach
            </tr>
