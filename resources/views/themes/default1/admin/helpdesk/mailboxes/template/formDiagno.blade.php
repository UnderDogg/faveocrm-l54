              ...
              <div class="col-md-4">
                ...
                <select name="from" class="form-control" id="from">
                  ...
                  <optgroup label="{!! Lang::get('lang.email') !!}">
                    ...
                    <?php
                    if ($mailbox->email_address == $mailbox->mailbox_name) {
                      $email1 = $mailbox->email_address;
                    } else {
                      $email1 = $mailbox->mailbox_name . ' ( ' . $mailbox->email_address . ' ) ';
                    }
                    ?>
                    <option value="{!! $mailbox->id !!}"> {{ $email1 }} </option>
                    @endforeach
                  </optgroup>
                </select>
              </div>
