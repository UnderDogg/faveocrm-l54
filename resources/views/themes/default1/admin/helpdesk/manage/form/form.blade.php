            ...
            <div class="tree-node">
              ...
              <div class="tree-node-content dropdown">
                ...
                <a class="pull-right btn btn-danger btn-xs" data-nodrag ng-click="remove(this)"
                   ng-show="node.default=='no'" style="padding: 3px 5px"><span
                    class="glyphicon glyphicon-remove"> </span></a>
                <a class="pull-right btn btn-info btn-xs collapser" data-toggle="collapse"
                   aria-controls="collapseExample" style="padding: 3px 5px"><span
                ...
                <div class="panel-collapse collapse" id="collapseExample" style="margin-top: 10px;">
                  <ul class="list-group">
                    <li class="list-group-item row" ng-show="node.title=='Requester'"
                        style="margin-left: 0px;margin-right: 0px">
                      <div class="col-sm-9">
                        <h3>Behaviour</h3>
                      </div>
                      <div class="col-sm-3">
                        <button type="button" class="btn btn-default btn-sm" ng-show="node.default=='yes'"
                                disabled="true">Default
                        </button>
                      </div>
                      <div class="col-sm-10">
                        <h4>For Agent</h4>
                        <div class="col-sm-2" style="padding-right: 0px"><input type="checkbox" class="form-control"
                                                                                ng-model="node.agentCCfield"
                                                                                style="margin-top: -6px;width: 17%;float: right">
                        </div>
                    ...
                    <li class="list-group-item row" ng-show="node.title!='Requester'"
                      ...
                      <div class="col-sm-6">
                        <h4>For Agent</h4>
                        <div class="col-sm-2" style="padding-right: 0px"><input type="checkbox" class="form-control"
                                                                                ng-model="node.agentRequiredFormSubmit"
                                                                                style="margin-top: -6px;width: 35%;float: right;">
                        </div>
                      ...
                      <div class="col-sm-6">
                        <h4>For Customers</h4>
                        <div class="col-sm-2" style="padding-right: 0px"><input type="checkbox" class="form-control"
                                                                                ng-model="node.customerDisplay"
                                                                                style="margin-top: -6px;width: 35%;float: right">
                        </div>
                        <div class="col-sm-10"><p>Display to customer</p></div>
                        <div class="col-sm-2" style="padding-right: 0px"><input type="checkbox" class="form-control"
                                                                                ng-model="node.customerRequiredFormSubmit"
                                                                                style="margin-top: -6px;width: 35%;float: right;">
                        </div>
                        <div class="col-sm-10"><p>Required when submitting the form</p></div>
                      </div>
                    </li>
                    <li class="list-group-item row" ng-show="node.label==''||node.label!=null"
                        style="margin-left: 0px;margin-right: 0px">
                      <div class="col-sm-3" style="line-height: 2.5"><label>Label</label></div>
                      <div class="col-sm-9"><input type="text" name="" class="form-control" ng-model="node.label"
                                                   style="border-radius: 0px" ng-disabled="node.default=='yes'"></div>
                    </li>
                    ...
                    <li class="list-group-item row" ng-show="node.title=='Api'"
                        style="margin-left: 0px;margin-right: 0px">
                      <div class="col-sm-3" style="line-height: 2.5"><label>Api Link</label></div>
                      <div class="col-sm-9"><input type="text" class="form-control" name="" ng-model="node.api"
                                                   style="border-radius: 0px"></div>
                      <div class="col-sm-3" style="line-height: 2.5"><label>Format</label></div>
                      <div class="col-sm-9">@{{node.format}}-->Ex:[{'id':'1','optionvalue':'Your
                        Options-1'},{'id':'2','optionvalue':'Your Options-2'}]
                      </div>
                    </li>
                    <li class="list-group-item row" style="margin-left: 0px;margin-right: 0px"
                        ng-repeat="option in node.options"
                        ng-show="node.type=='radio'||node.type=='select' ||node.type=='checkbox' && node.default=='no'">
                      <div class="col-sm-3" style="line-height: 2.5"><label>Option@{{$index+1}}</label></div>
                      <div class="col-sm-6"><input type="text" class="form-control" name=""
                                                   ng-model="option.optionvalue" style="border-radius: 0px">
                      </div>
                      <div class="col-sm-3">
                        ...
                        <div class="dropdown"
                             ng-show="node.title=='Nested Select'||node.title=='Nested Radio' ||node.title=='Nested Checkbox'">
                          <a class="pull-right btn btn-primary btn-xs dropdown-toggle" data-toggle="dropdown"
                             data-nodrag style="margin-right: 8px;">
                            <span class="glyphicon glyphicon-plus"></span> Add
                          </a>
                          <ul class="dropdown-menu">
                            <li ng-repeat="Ifield in tree1"><a href="javascript:void(0)"
                                                               ng-click="newSubForm(this,Ifield.title,$parent.$index)">@{{Ifield.title}}</a>
                            </li>
                          </ul>
                        </div>
                      </div>
                    ...
                    <li class="list-group-item row" style="margin-left: 0px;margin-right: 0px;text-align: center;"
                        ng-show="node.title=='Nested Select'||node.title=='Nested Radio'||node.title=='Nested Checkbox'">
                      <input type="button" name="addOption" class="btn btn-default" value="Add Option"
                             ng-click="addOption(this,node.type)">
                    </li>
                    <li class="list-group-item row" style="margin-left: 0px;margin-right: 0px;text-align: center;"
                        ng-show="node.title!='Nested Radio' && node.type=='radio'||node.title!='Nested Checkbox' && node.type=='checkbox'||node.type=='select' && node.title!='Nested Select'&& node.default=='no'">
                      <input type="button" name="addOption" class="btn btn-default" value="Add Option"
                             ng-click="addTypeOption(this,node.type)">
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div class="col-sm-12" style="background-color: white;" id="category">
                ...
                <div ui-tree id="tree1-root" data-clone-enabled="true" data-nodrop-enabled="true" class="col-sm-12">
                  <ol ui-tree-nodes="" ng-model="tree1" class="list-inline" style="margin-bottom: 15px;">
                    <li ng-repeat="node in tree1" ui-tree-node ng-include="'nodes_renderer1.html'"
                        ng-click="addToTree(node)"></li>
                  </ol>
                </div>
              </div>
              <div class="col-sm-12">
