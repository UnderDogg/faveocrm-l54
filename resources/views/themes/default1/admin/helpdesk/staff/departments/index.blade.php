...
@section('content')
  <div class="box box-primary">
    <div class="box-header">
      <h2 class="box-title">{!! Lang::get('lang.list_of_departments') !!}</h2><a href="{{route('departments.create')}}"
                                                                                 class="btn btn-primary pull-right"><span
          class="glyphicon glyphicon-plus"></span> &nbsp;{{Lang::get('lang.create_a_department')}}</a></div>
            ...
            @foreach($departments as $department)
              <tr>
                ...
                if ($department->manager == 0) {
                  ...
                  $manager = App\Staff::whereId($department->manager)->first();
