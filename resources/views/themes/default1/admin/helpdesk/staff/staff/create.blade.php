...
@section('breadcrumbs')
  ...
  @section('content')
    <!-- open a form -->
  {!! Form::open(array('action' => 'Admin\helpdesk\StaffController@store' , 'method' => 'post') )!!}
      ...
      @if(Session::has('errors'))
        ...
        <div class="row">
          ...
          <div class="col-xs-4 form-group {{ $errors->has('primary_department') ? 'has-error' : '' }}">
            ...
            Lang::get('lang.departments')=>$departments->pluck('name','id')->toArray()],'',['class' => 'form-control
            select']) !!}
          </div>
          ...
          <div class="col-xs-4 form-group {{ $errors->has('agent_time_zone') ? 'has-error' : '' }}">
            ...
            [''=>Lang::get('lang.select_a_time_zone'),Lang::get('lang.time_zones')=>$timezones],null,['class' =>
            'form-control select']) !!}
          </div>
        </div>
        <!-- Assign team -->
