      ...
      <div class="box box-primary">
        <div class="box-header">
          ...
          <div class="pull-right">
            ...
            <button type="button" class="btn btn-default"><i class="fa fa-print" style="color:blue;"> </i> Print
            </button>
            <!-- </div> -->
            <div class="btn-group">
            ...
            <div class="btn-group">
              <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown"><i class="fa fa-cogs"
                                                                                                      style="color:teal;"> </i>
        ...
        <div class='col-xs-12'>
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="#Reply" data-toggle="tab" style="color:orange;"><i class="fa fa-mail-forward"> </i>
                  Forward</a></li>
            </ul>
            <div class="tab-content">
              ...
              <div class="tab-pane" id="Reply">
                <div class="form-group">
                  ...
                  <button type="button" class="btn btn-default"><i class="fa fa-th-large" style="color:teal;"> </i>
                    Option
                  </button>
                  <button type="button" class="btn btn-default"><i class="fa fa-file-text" style="color:blue;"> </i>
                    Internal Notes
