...
<div class="wrapper" id="RefreshAssign">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li class="treeview @yield('category')">
          ...
          <ul class="treeview-menu">
            <li @yield('add-category')><a href="{{url('category/create')}}"><i class="fa fa-circle-o"></i>Add
                Category</a></li>
            <li @yield('all-category')><a href="{{url('category')}}"><i class="fa fa-circle-o"></i> All Category</a>
            </li>
          </ul>
        </li>
        <li class="treeview @yield('article')">
          ...
          <ul class="treeview-menu">
            <li @yield('add-article')><a href="{{url('article/create')}}"><i class="fa fa-circle-o"></i>Add Article</a>
            </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; {{date("Y")}} <a href="{{$settings->website}}"> {{$settings->company_name}}</a>. Powered By
      <a href="http://www.faveohelpdesk.com">Faveo</a>.</strong>
  </footer>
