  ...
  <div class="box box-primary">
    <div class="box-header">
      ...
      <div class="pull-right">
        ...
        ?>
        <button type="button" class="btn btn-sm btn-default" id="Edit_Ticket" data-toggle="modal" data-target="#Edit"><i
            class="fa fa-edit" style="color:green;"> </i> {!! Lang::get('lang.edit') !!}</button>
        <?php } ?>

        <?php if ($ticket_policy->assign()) { ?>
        <button type="button" class="btn btn-sm btn-default" data-toggle="modal" data-target="#{{$tickets->id}}assign">
          <i class="fa fa-hand-o-right" style="color:orange;"> </i> {!! Lang::get('lang.assign') !!}</button>
        <?php } ?>
        ...
        @if($tickets->assigned_to == Auth::user()->id)
          <button type="button" id="surrender_button" class="btn btn-sm btn-default" data-toggle="modal"
                  data-target="#surrender"><i class="fa fa-arrows-alt"
                                              style="color:red;"> </i> {!! Lang::get('lang.surrender') !!}</button>
        @endif
        ...
        <div class="btn-group">
          ...
          <ul class="dropdown-menu">
            @foreach($statuses as $ticket_status)
              <li onclick="changeStatus({!! $ticket_status -> id !!})"><a href="#"><i
                    class="{!! $ticket_status->icon !!}"
                    style="color:{!! $ticket_status->icon_color !!};"> </i>{!! $ticket_status->name !!}</a></li>
            @endforeach
          </ul>
        </div>
        ...
        <div id="more-option" class="btn-group">
          ...
          <ul class="dropdown-menu pull-right">
            <li data-toggle="modal" data-target="#ChangeOwner"><a href="#"><i class="fa fa-users"
                                                                              style="color:green;"> </i>Change Owner</a>
            </li>
            ...
            <li id="delete"><a href="#"><i class="fa fa-trash-o"
                                           style="color:red;"> </i>{!! Lang::get('lang.delete_ticket') !!}</a></li>
            <?php }
            ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <button type="button" class="btn btn-sm btn-default" data-toggle="modal"
                              data-target="#{{$tickets->id}}depttransfer"><i class="fa fa-hand-o-right"
                                                                             style="color:orange;"> </i> {!! Lang::get('lang.change_department') !!}
                      </button>
                    </td>
                  </tr>
                        ...
                        <div id="refreshTo">
                          ...
                          <div id="recepients">
                            ...
                            @if($count_collaborator > 0)
                              <a href="#" data-toggle="modal" data-target="#surrender2">({!! $count_collaborator !!}
                ...
                <div class="form-group">
                  <div class="row">
                    <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                      ...
                      <div class="col-md-10">
                        <div id="t5">
                          <button id="replybtn" ng-click="getEditor()" type="button" class="btn btn-primary"><i
                              class="fa fa-check-square-o" style="color:white;"> </i> {!! Lang::get('lang.update') !!}
                          </button>
                        </div>
                      </div>
                    </div>
            ...
            <ul class="timeline">
              ...
              <li>
                ...
                <div class="timeline-item">
                                        <span style="color:#fff;"><div class="pull-right">
                                            <table>
                                              <tbody>
                                              @if($role)
                                                @if($role->role != null)
                                                        ...
                                                        <tr>
                                                          <th>
                                                            <div class="ticketratingtitle"
                                                                 style="color:#3c8dbc;">{!! $rating->name !!}
                                                              &nbsp;</div>
                                                          </th>
                                                          &nbsp
                  ...
                  <h3 class="timeline-header">
                    ...
                    <div class="user-block" style="margin-bottom:-5px;margin-top:-2px;">
                      ...
                      <span class="description" style="margin-bottom:4px;margin-top:4px;"><i
                          class="fa fa-clock-o"></i> {{faveoDate($conversation->created_at)}}</span>
                      @if($conversation->id == $ij->id)
                        <a href="{{url('genereate-pdf/'.$conversation->id)}}" class="pull-right fa fa-newspaper-o"
                  ...
                  <div class="timeline-body{{$conversation->id}}"
      ...
      <div class="modal-dialog" style="width:60%;height:70%;">
        <div class="modal-content">
          ...
          <div class="modal-header">
            ...
            <h4 class="modal-title">{!! Lang::get('lang.edit') !!} <b>[#{!! $tickets->ticket_number !!}
                ]</b>[{!! $user->user_name !!}]</h4>
          </div>
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="#haha2" data-toggle="tab" style="color:orange;"><i
                    class="fa fa-user-plus"> </i> {!! Lang::get('lang.add_new_user') !!}</a></li>
            </ul>
            <div class="tab-content">
              <div class="tab-pane active" id="ahah1">
                <div id="change_alert" class="alert alert-danger alert-dismissable" style="display:none;">
                  <button id="change_dismiss" type="button" class="close" data-dismiss="alert" aria-hidden="true">×
                  </button>
              ...
              <div class="tab-pane" id="haha2">
                ...
                <div class="modal-body" id="abc">
                  ...
                  <div id="add-change-body">
                    <input type="text" name="name" class="form-control" placeholder="{!! Lang::get('lang.name') !!}"
                           required>
                    <input type="email" name="email" class="form-control" placeholder="{!! Lang::get('lang.e-mail') !!}"
                           required>
                    <input type="hidden" name="ticket_id" value="{!! $tickets->id !!}">
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="ahah">
                <div class="modal-body" id="def">
                  <div class="callout callout-info" id="hide1234"><i
                      class="icon fa fa-info"> </i>&nbsp;&nbsp;&nbsp; {!! Lang::get('lang.search_existing_users_or_add_new_users') !!}
                  </div>
                  <div id="here"></div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-default pull-left" data-dismiss="modal"
                    id="dismis4">{!! Lang::get('lang.close') !!}</button>
            <button type="submit" class="btn btn-success pull-right"
                    id="submt2">{!! Lang::get('lang.submit') !!}</button>
          </div>
          {!! Form::close()!!}
        </div><!-- /.modal-content -->
      </div><!-- /.modal-dialog -->
            ...
            <div id="merge-body-form">
              ...
              <div class="row">
                <div class="col-md-8">
                  ...
                  <select class="form-control select2" id="select-merge-tickts" name="t_id[]" multiple="multiple"
                          data-placeholder="{!! Lang::get('lang.select_tickets') !!}" style="width: 100%;">
