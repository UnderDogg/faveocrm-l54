        ...
        <input type="submit" class="btn btn-default text-yellow btn-sm" name="submit"  id="close" value="{!! Lang::get('lang.close') !!}">-->
          <div class="btn-group">
            ...
            <ul class="dropdown-menu">
              <li><input type="submit" class="btn btn-block btn-default btn-sm text-green" id="open" name="submit"
                         value="{!! Lang::get('lang.open') !!}" onclick="appendValue(id)">
              </li>
              <li><input type="submit" class="btn btn-block btn-default btn-sm text-yellow" name="submit" id="close"
                         value="{!! Lang::get('lang.close') !!}" onclick="appendValue(id)"></li>
