            ...
            @if(Session::has('errors'))
              ...
              <div class="row">
                ...
                <div class="col-xs-2 form-group {{ Session::has('country_code_error') ? 'has-error' : '' }}">
                  ...
                  Lang::get('lang.enter-country-phone-code'), 'id' => 'code']) !!}
                </div>
                <!-- phone number -->
          ...
          <div class="modal-body">
            ...
            <div id="verify-number-form">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  {!! Form::text('token','',['class' => 'form-control', 'required' => true, 'placeholder' =>
                  Lang::get('lang.enter-otp'), 'id' => 'otp']) !!}
                </div>
              </div>
            </div>
          </div>
          <div class="modal-footer">
            <button type="button" id="close-last" class="btn btn-default closemodal pull-left">
              {{Lang::get('lang.close')}}
            </button>
