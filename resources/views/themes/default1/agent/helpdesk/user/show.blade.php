            ...
            @if($users->is_delete != '1')
                ...
                <div class="box-footer">
                  <div id="refresh-org">
                    ...
                    @if($user_org != null)
                      ...
                      <a href="" data-toggle="modal" data-target="#editassign" title="{{$organization->name}}"> <span
                      ...
                      <a class="pull-right" href="#" data-toggle="modal" data-target="#{{$org_id}}delete"
                         title="{!! Lang::get('lang.remove') !!}"><i class="fa fa-times" style="color:red;"> </i></a>
              ...
              @if($policy->emailVerification())
                <div class="box-footer">
                  ...
                  <a class="pull-right">
                    <div
                      class="btn-group {{$users->active == '0' ? 'locked_active unlocked_inactive' : 'locked_inactive unlocked_active'}}"
                      id="toggle_event_editing" style="margin-top:-8px">
                      <button type="button"
                              class="btn {{$users->active == '1' ? 'btn-sm btn-info' : 'btn-sm btn-default'}}">{{Lang::get('lang.yes')}}</button>
                      <button type="button"
                              class="btn {{$users->active == '0' ? 'btn-sm btn-info' : 'btn-sm btn-default'}}">{{Lang::get('lang.no')}}</button>
                    </div>
              ...
              @if($policy->mobileVerification())
                <div class="box-footer">
                  ...
                  <a class="pull-right">
                    ...
                    <div
                      class="btn-group {{$users->mobile_verify == '0' ? 'locked_active_mobile unlocked_inactive_mobile' : 'locked_inactive_mobile unlocked_active_mobile'}}"
                      id="toggle_event_editing_mobile" style="margin-top:-8px">
                      <button type="button"
                              class="btn {{$users->mobile_verify == '1' ? 'btn-sm btn-info' : 'btn-sm btn-default'}}">{{Lang::get('lang.yes')}}</button>
                      <button type="button"
                              class="btn {{$users->mobile_verify == '0' ? 'btn-sm btn-info' : 'btn-sm btn-default'}}">{{Lang::get('lang.no')}}</button>
                    </div>
              ...
              @if($policy->ban())
                <div class="box-footer">
                  ...
                  <div class="pull-right">
                    ...
                    <div
                      class="btn-group {{$users->ban == '0' ? 'locked_active_ban unlocked_inactive_ban' : 'locked_inactive_ban unlocked_active_ban'}}"
                      id="toggle_event_editing_ban" style="margin-top:-8px">
                      <button type="button"
                              class="btn {{$users->ban == '1' ? 'btn-sm btn-info' : 'btn-sm btn-default'}}">{{Lang::get('lang.yes')}}</button>
                      <button type="button"
                              class="btn  {{$users->ban == '0' ? 'btn-sm btn-info' : 'btn-sm btn-default'}}">{{Lang::get('lang.no')}}</button>
                    </div>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <br/>
                <form name="myForm" action="{!!URL::route('user.post.changepassword', $users->id)!!}" method="post"
                      ...
                      @if(Auth::user()->role == 'admin')
                        <div id="page" class="hfeed site">
                          <article class="hentry error404 text-center">
                            <h1 class="error-title"><i class="fa fa-trash text-info" style="color: grey"></i><span
                            ...
                            <div class="entry-content clearfix">
                              ...
                              <p>
                                <button type="button" href="#myPopup" data-rel="popup" class="btn btn-primary btn-xs"
                                        data-toggle="modal"
                    ...
                    <div style="padding:1%;">
                      <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="#tab_1" id="open_tab"
                                              data-toggle="tab">{!! Lang::get('lang.open_tickets') !!} ({{$open}})</a>
                        </li>
                        <li><a href="#tab_2" id="closed_tab" data-toggle="tab">{!! Lang::get('lang.closed_tickets') !!}
                            ({{$counted}})</a></li>
                        <li><a href="#tab_3" id="deleted_tab"
                               data-toggle="tab">{!! Lang::get('lang.deleted_tickets') !!} ({{$deleted}})</a></li>
                      </ul>
                        ...
                        @if(Session::has('success'))
                          ...
                          <div class="mailbox-controls">
                            ...
                            <input type="submit" class="btn btn-default text-orange btn-sm" name="submit"
                                   value="{!! Lang::get('lang.delete') !!}" id="delete" onclick="appendValue(id)">
                            <input type="submit" class="btn btn-default text-orange btn-sm" name="submit"
                                   value="{!! Lang::get('lang.close') !!}" id="close" onclick="appendValue('close')">
                            <input type="submit" class="btn btn-default text-blue btn-sm" name="submit"
                                   value="{!! Lang::get('lang.open') !!}" id="open" onclick="appendValue(id)"
                                   style="display: none;">
                            <div class="pull-right">
                            </div>
                            <!--</div>-->
                            <div id="more-option" class="btn-group">
                              ...
                              <ul class="dropdown-menu pull-right">
                                <li data-toggle="modal" data-target="#ChangeOwner"><a href="#" class="toggle-vis"
                                                                                      data-column="7"><i
                                      class="fa fa-plus-square-o"
                                      style="color:green;"> </i>{!!Lang::get('lang.created-at')!!}</a></li>
                              </ul>
                            </div>
                          </div>
                          ...
                          <div class="box-body mailbox-messages" id="refresh">
                            <p style="display:none;text-align:center; position:fixed; margin-left:40%;margin-top:-70px;"
                               id="show" class="text-red"><b>{!! Lang::get('lang.loading') !!}...</b></p>
                            <!-- table -->
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-10">
                            ...
                            <div class="row">
                              <style>
                                #legend-holder
                                { border: 1px solid #ccc; float: left; width: 25px; height: 25px; margin: 1px; }
                              </style>
          ...
          <div class="modal fade" id="editassign">
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                ...
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" id="editdismiss" aria-label="Close"><span
                      aria-hidden="true">&times;</span></button>
                  <h4 class="modal-title">{!! Lang::get('lang.assign') !!}</h4>
                </div>
                <!--   <div id="assign_alert" class="alert alert-success alert-dismissable" style="display:none;">
