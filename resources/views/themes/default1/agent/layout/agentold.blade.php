          ...
          @if(Auth::user()->role == 'admin')
            ...
            <li class="dropdown notifications-menu" id="myDropdown">
              ...
              <ul class="dropdown-menu" style="width:500px">
                ...
                <li class="header">You have {!! count($noti) !!} notifications. <a class="pull-right" id="read-all"
                                                                                   href="#">Mark all as read.</a></li>
                ...
                <ul class="menu">
                  @foreach($notifications as $notification)
                    ...
                    @if($notification->type == 'registration')
                      @if($notification->is_read == 1)
                        <li class="task" style="list-style: none; margin-left: -30px;"><span>&nbsp<img
                              src="{{$user -> profile_pic}}" class="user-image" style="width:6%;height: 5%"
                              alt="User Image"/>
                      ...
                      @else
                        <li style="list-style: none; margin-left: -30px;"><span>&nbsp<img src="{{$user -> profile_pic}}"
                                                                                          class="user-image"
                    ...
                    @else
                      ...
                      @if($notification->is_read == 1)
                        <li class="task" style="list-style: none;margin-left: -30px"><span>&nbsp<img
                              src="{{$user -> profile_pic}}" class="img-circle" style="width:6%;height: 5%"
                              alt="User Image"/>
          ...
          @if($replacetop==0)
            ...
            <div class="tabs-pane @yield('ticket-bar')" id="tabC">
              <ul class="nav navbar-nav">
                ...
                <li id="bar" @yield('myticket')><a
                    href="{{ url('/ticket/myticket')}}">{!! Lang::get('lang.my_tickets') !!}</a></li>
                ...
                <li id="bar" @yield('closed')><a href="{{ url('/ticket/closed')}}">{!! Lang::get('lang.closed') !!}</a>
                </li>
            ...
            <div class="tabs-pane @yield('tools-bar')" id="tabD">
              <ul class="nav navbar-nav">
                ...
                <li id="bar" @yield('kb')><a href="{{ url('/comment')}}">{!! Lang::get('lang.knowledge_base') !!}</a>
                </li>
              </ul>
            </div>
            @if(Auth::user()->role == 'admin')
