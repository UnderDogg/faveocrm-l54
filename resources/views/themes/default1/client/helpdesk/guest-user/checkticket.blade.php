        ...
        <section class="content" id="refresh">
          ...
          <div class="col-md-6">
            <table class="table table-hover">
              ...
              <tr>
                <td><b>Status:</b>
                </td> <?php $status = App\Model\Ticket\Ticket_Status::where('id', '=', $tickets->status)->first();?>
                <td title="{{$status->properties}}">{{$status->state}}</td>
              </tr>
              <tr>
                <td><b>Priority:</b>
                </td> <?php $priority = App\Model\Ticket\Ticket_Priority::where('priority_id', '=', $tickets->priority_id)->first();?>
                <td title="{{$priority->priority_desc}}">{{$priority->priority}}</td>
              </tr>
              <tr>
                <td><b>Department:</b>
                </td> <?php $help_topic = App\Model\Manage\Help_topic::where('id', '=', $tickets->help_topic_id)->first();?>
    ...
    <div class='col-xs-12'>
      <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
          <li class="active"><a href="#General" data-toggle="tab" style="color:green;"><i class="fa fa-reply-all"> </i>
              Reply</a></li>
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane active" id="General">
            ...
            <div id="t2" style="display:none">
              ...
              <div class="form-group">
                ...
                <button type="button" class="btn btn-default"><i class="fa fa-arrows-alt" style="color:red;"> </i>
                  Surrender
                </button>
              </div>
              <div class="form-group">
          ...
          <div class="tab-pane" id="Reply">
            <div class="form-group">
              <button type="button" class="btn btn-default"><i class="fa fa-mail-forward" style="color:green;"> </i>
                Send
              </button>
              <button type="button" class="btn btn-default"><i class="fa fa-th-large" style="color:teal;"> </i> Option
              </button>
              <button type="button" class="btn btn-default"><i class="fa fa-file-text" style="color:blue;"> </i>
                Internal Notes
              </button>
            </div>
            <form>
