    ...
    <div class="box-header">
      ...
      <div class="pull-right">
        ...
        <button type="button" class="btn btn-default" id="Edit_Ticket" data-toggle="modal" data-target="#Edit"><i
            class="fa fa-edit" style="color:green;"> </i> Edit
        </button>
          ...
          <div class="col-md-12">
            ...
            <div class="callout callout-{{$priority->priority_color}}">
              <div class="row">
                ...
                <div class="col-md-3">
                  <b>Created Date: </b> {{ faveoDate($tickets->created_at) }}
                </div>
                <div class="col-md-3">
                  <b>Due Date: </b>
                  <?php
          ...
          <div id="hide2">
            <div class="col-md-6">
              <table class="table table-hover" id="refresh">
                <tr>
                  <td><b>Status:</b></td>
                  <div><?php $status = App\Model\Ticket\Ticket_Status::where('id', '=', $tickets->status)->first();?>
          ...
          <div class="tab-pane active" id="General">
            <div class="form-group">
              ...
              <button type="button" class="btn btn-default" data-toggle="modal" data-target="#{{$tickets->id}}assign"><i
                  class="fa fa-hand-o-right" style="color:orange;"> </i> Assign
              </button>
