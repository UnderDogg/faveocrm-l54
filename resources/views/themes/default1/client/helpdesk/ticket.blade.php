    ...
    <div class="box box-primary">
      <div class="box-header">
        ...
        <div class="pull-right">
          ...
          <a href="{{url('ticket/print/'.$ticket->id)}}" target="_blank" class="btn btn-default"><i class="fa fa-print"
                                                                                                    style="color:blue;"> </i>
            Print</a>
          <div class="btn-group">
            ...
            <ul class="dropdown-menu">
              ...
              <li id="resolved"><a href="#"><i class="fa fa-check-circle-o " style="color:green;"> </i> Resolved</a>
              </li>
            </ul>
          </div>
            ...
            <div id="hide2">
              <div class="col-md-6">
                <table class="table table-hover" id="refresh">
                  ...
                  <tr>
                    <td><b>Priority:</b>
                    </td> <?php $priority = App\Model\Ticket\Ticket_Priority::where('priority_id', '=', $ticket->priority_id)->first();?>
                    <td title="{{$priority->priority_desc}}">{{$priority->priority_desc}}</td>
                  </tr>
                  <tr>
                    <td><b>Department:</b>
                    </td> <?php $help_topic = App\Model\Manage\Help_topic::where('id', '=', $ticket->help_topic_id)->first();?>
              ...
              <div class="col-md-6">
                ...
                <table class="table table-hover">
                  ...
                  <tr>
                    <td><b>Status:</b></td>
                    <div><?php $status = App\Model\Ticket\Ticket_Status::where('id', '=', $ticket->status)->first();?>
                    ...
                    <div class="timeline-footer" style="margin-bottom:-5px">
                      ...
                      <ul class='mailbox-attachments clearfix'>
                        ...
                        $var = '<a href="'.URL::route('image', array('image_id' => $attachment->id)).'" target="_blank"><img
                            style="max-width:200px;height:133px;"
                            src="data:image/jpg;base64,' . base64_encode($data)  . '"/></a>';


                        echo '
                        <li style="background-color:#f4f4f4;"><span
                            class="mailbox-attachment-icon has-img">'.$var.'</span>
                          <div class="mailbox-attachment-info"><b
                              style="word-wrap: break-word;">'.$attachment->name.'</b><br/>
                            <p>'.$value.'</p></div>
                        </li>
                        ';
                        }
                        ...
                        $var = '<a style="max-width:200px;height:133px;color:#666;"
                          ...
                          <div class="mailbox-attachment-info"><span><b style="word-wrap: break-word;">'.$attachment->name.'</b><br/><p>
                                '.$value.'</p></span></div>
                        </a>';
                        echo '
