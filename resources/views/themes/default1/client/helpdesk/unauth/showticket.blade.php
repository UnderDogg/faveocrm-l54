...
@section('content')
<?php
$thread = App\Model\helpdesk\Ticket\TicketThread::where('ticket_id', '=', $tickets->id)->first();
          ...
          <div class="btn-group">
            ...
            <ul class="dropdown-menu" id='cc_page'>
              @foreach($statuses as $status)
                <?php if ($status->name == 'Deleted' or $status->name == 'Accepted')
                  continue; ?>
                <li class="search_r"><a href="#" onclick="changeStatus({!! $status->id !!})"><i
                      class="{!! $status->icon_class !!}" style="color:#FFD600;"> </i>{!! $status->name !!}</a>
                </li>
              @endforeach
      ...
      <div class="timeline-footer" style="margin-bottom:-5px">
        ...
        <ul class='mailbox-attachments clearfix'>
          ...
          $var = '<a style="max-width:200px;height:133px;color:#666;"
            ...
            <div class="mailbox-attachment-info"><span><b style="word-wrap: break-word;">' . $attachment->name .
                  '</b><br/><p>' . $value . '</p></span></div>
          </a>';
          echo '
