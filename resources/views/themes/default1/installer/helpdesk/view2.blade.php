...
@section('content')
  ...
  <div id="form-content">
    ...
    <div id="wrapper">
      ...
      <br/><br/>
      <p>NOTE:&nbsp;FAVEO doesn't work properly without JavaScript. In order to install and run FAVEO to its full extent
        please make sure JavaScript is enabled in your browser.</p>
      <?php
